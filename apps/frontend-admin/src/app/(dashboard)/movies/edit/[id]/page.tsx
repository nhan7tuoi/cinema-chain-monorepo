      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white">Chỉnh sửa phim</h1>
          </div>
          <p className="text-sm text-slate-500 dark:text-slate-400 pl-9">Cập nhật thông tin chi tiết của bộ phim</p>
        </div>
      </div>
